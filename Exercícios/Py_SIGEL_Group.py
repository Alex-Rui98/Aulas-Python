...
def prPurple(skk): print("\033[35;04m {}\033[00m" .format(skk))


def prCyan(skk): print("\033[96m {}\033[00m" .format(skk))


def prBlackRedBg(skk): print("\033[30;41m {}\033[00m" .format(skk))
...
def add_book():
    ...
    resp_add = input("Assegure-se que tem todos os dados necessarios que possam identificar o livro,"
                     " normalmente encontrados nas primeiras paginas do mesmo.\n[Y] para continuar."
                     "\n[N] Para voltar ao menu anterior. \n---->").strip().upper()
...
def menu():
    ...
    prBlackRedBg(center_text('GESTÃO DE LIVROS', 40))
    ...
    while opcao != 6:
        ...
        if opcao == "1":
            prPurple("Opção 1 selecionada: Adicionar Livro")
            # Add book
            add_book()
        # Do (else if) validate by if the variable "opcao" is set 2
        elif opcao == "2":
            prPurple("Opção 2 selecionada: Remover")
            # Remove book
            rem_book()
